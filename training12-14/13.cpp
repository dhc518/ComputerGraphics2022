...
void draw_middle_line()
{
	...
	/*
	middle_line[0][0] = 0;  middle_line[0][1] = 0;  middle_line[0][2] = 0;
	middle_line[1][0] = 0;  middle_line[1][1] = 0;  middle_line[1][2] = 0;
	middle_line[2][0] = 0;  middle_line[2][1] = 0;  middle_line[2][2] = 0;
	middle_line[3][0] = 0;  middle_line[3][1] = 0;  middle_line[3][2] = 0;
	*/
}
